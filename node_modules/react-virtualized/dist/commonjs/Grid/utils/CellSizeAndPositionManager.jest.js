...
describe('CellSizeAndPositionManager', function () {
  function getCellSizeAndPositionManager() {
    ...
    var cellCount = _ref$cellCount === undefined ? 100 : _ref$cellCount;
    var _ref$estimatedCellSiz = _ref.estimatedCellSize;
    var estimatedCellSize = _ref$estimatedCellSiz === undefined ? 15 : _ref$estimatedCellSiz;
  ...
  describe('configure', function () {
    it('should update inner :cellCount and :estimatedCellSize', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi.cellSizeAndPositionManager;
  ...
  describe('findNearestCell', function () {
    it('should error if given NaN', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi2.cellSizeAndPositionManager;
    ...
    it('should gracefully handle offets outisde of bounds (to account for elastic scrolling)', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi3.cellSizeAndPositionManager;
    ...
    it('should find the first cell', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi4.cellSizeAndPositionManager;
    ...
    it('should find the last cell', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi5.cellSizeAndPositionManager;
    ...
    it('should find the a cell that exactly matches a specified offset in the middle', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi6.cellSizeAndPositionManager;
    ...
    it('should find the cell closest to (but before) the specified offset in the middle', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi7.cellSizeAndPositionManager;
  ...
  describe('getSizeAndPositionOfCell', function () {
    it('should error if an invalid index is specified', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi8.cellSizeAndPositionManager;
    ...
    it('should returnt he correct size and position information for the requested cell', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi9.cellSizeAndPositionManager;
    ...
    it('should only measure the necessary cells to return the information requested', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi10.cellSizeAndPositionManager;
      var cellSizeGetterCalls = _getCellSizeAndPositi10.cellSizeGetterCalls;
    ...
    it('should just-in-time measure all cells up to the requested cell if no cells have yet been measured', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi11.cellSizeAndPositionManager;
      var cellSizeGetterCalls = _getCellSizeAndPositi11.cellSizeGetterCalls;
    ...
    it('should just-in-time measure cells up to the requested cell if some but not all cells have been measured', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi12.cellSizeAndPositionManager;
      var cellSizeGetterCalls = _getCellSizeAndPositi12.cellSizeGetterCalls;
    ...
    it('should return cached size and position data if cell has already been measured', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi13.cellSizeAndPositionManager;
      var cellSizeGetterCalls = _getCellSizeAndPositi13.cellSizeGetterCalls;
  ...
  describe('getSizeAndPositionOfLastMeasuredCell', function () {
    it('should return an empty object if no cached cells are present', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi14.cellSizeAndPositionManager;
    ...
    it('should return size and position data for the highest/last measured cell', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi15.cellSizeAndPositionManager;
  ...
  describe('getTotalSize', function () {
    it('should calculate total size based purely on :estimatedCellSize if no measurements have been done', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi16.cellSizeAndPositionManager;
    ...
    it('should calculate total size based on a mixture of actual cell sizes and :estimatedCellSize if some cells have been measured', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi17.cellSizeAndPositionManager;
    ...
    it('should calculate total size based on the actual measured sizes if all cells have been measured', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi18.cellSizeAndPositionManager;
  ...
  describe('getUpdatedOffsetForIndex', function () {
    function getUpdatedOffsetForIndexHelper(_ref3) {
      ...
      var _ref3$cellCount = _ref3.cellCount;
      var cellCount = _ref3$cellCount === undefined ? 10 : _ref3$cellCount;
      var _ref3$cellSize = _ref3.cellSize;
      var cellSize = _ref3$cellSize === undefined ? 10 : _ref3$cellSize;
      var _ref3$containerSize = _ref3.containerSize;
      var containerSize = _ref3$containerSize === undefined ? 50 : _ref3$containerSize;
      var _ref3$currentOffset = _ref3.currentOffset;
      var currentOffset = _ref3$currentOffset === undefined ? 0 : _ref3$currentOffset;
      var _ref3$estimatedCellSi = _ref3.estimatedCellSize;
      var estimatedCellSize = _ref3$estimatedCellSi === undefined ? 15 : _ref3$estimatedCellSi;
      var _ref3$targetIndex = _ref3.targetIndex;
      var targetIndex = _ref3$targetIndex === undefined ? 0 : _ref3$targetIndex;
  ...
  describe('getVisibleCellRange', function () {
    it('should not return any indices if :cellCount is 0', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi19.cellSizeAndPositionManager;
      ...
      var start = _cellSizeAndPositionM.start;
      var stop = _cellSizeAndPositionM.stop;
    ...
    it('should return a visible range of cells for the beginning of the list', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi20.cellSizeAndPositionManager;
      ...
      var start = _cellSizeAndPositionM2.start;
      var stop = _cellSizeAndPositionM2.stop;
    ...
    it('should return a visible range of cells for the middle of the list where some are partially visible', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi21.cellSizeAndPositionManager;
      ...
      var start = _cellSizeAndPositionM3.start;
      var stop = _cellSizeAndPositionM3.stop;
    ...
    it('should return a visible range of cells for the end of the list', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi22.cellSizeAndPositionManager;
      ...
      var start = _cellSizeAndPositionM4.start;
      var stop = _cellSizeAndPositionM4.stop;
  ...
  describe('resetCell', function () {
    it('should clear size and position metadata for the specified index and all cells after it', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi23.cellSizeAndPositionManager;
    ...
    it('should not clear size and position metadata for cells before the specified index', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi24.cellSizeAndPositionManager;
      var cellSizeGetterCalls = _getCellSizeAndPositi24.cellSizeGetterCalls;
    ...
    it('should not skip over any unmeasured or previously-cleared cells', function () {
      ...
      var cellSizeAndPositionManager = _getCellSizeAndPositi25.cellSizeAndPositionManager;
