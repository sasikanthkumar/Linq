...
describe('calculateSizeAndPositionDataAndUpdateScrollOffset', function () {
  function helper() {
    ...
    var cellSize = _ref$cellSize === undefined ? 10 : _ref$cellSize;
    var _ref$computeMetadataC = _ref.computeMetadataCallbackProps;
    var computeMetadataCallbackProps = _ref$computeMetadataC === undefined ? {} : _ref$computeMetadataC;
    var _ref$nextCellsCount = _ref.nextCellsCount;
    var nextCellsCount = _ref$nextCellsCount === undefined ? 100 : _ref$nextCellsCount;
    var _ref$nextCellSize = _ref.nextCellSize;
    var nextCellSize = _ref$nextCellSize === undefined ? 10 : _ref$nextCellSize;
  ...
  it('should call :computeMetadataCallback if :cellCount has changed', function () {
    ...
    var computeMetadataCallbackCalls = _helper.computeMetadataCallbackCalls;
  ...
  it('should call :computeMetadataCallback if numeric :cellSize has changed', function () {
    ...
    var computeMetadataCallbackCalls = _helper2.computeMetadataCallbackCalls;
  ...
  it('should not call :computeMetadataCallback if :cellSize callback has changed', function () {
    ...
    var computeMetadataCallbackCalls = _helper3.computeMetadataCallbackCalls;
  ...
  it('should not call :updateScrollOffsetForScrollToIndex if :scrollToIndex is not specified', function () {
    ...
    var updateScrollOffsetForScrollToIndexCalls = _helper4.updateScrollOffsetForScrollToIndexCalls;
  ...
  it('should not call :updateScrollOffsetForScrollToIndex if :scrollToIndex has also changed', function () {
    ...
    var updateScrollOffsetForScrollToIndexCalls = _helper5.updateScrollOffsetForScrollToIndexCalls;
  ...
  it('should not call :computeMetadataCallback if the above conditions are not true', function () {
    ...
    var computeMetadataCallbackCalls = _helper6.computeMetadataCallbackCalls;
