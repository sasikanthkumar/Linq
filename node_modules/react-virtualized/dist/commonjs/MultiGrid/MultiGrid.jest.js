...
describe('MultiGrid', function () {
  ...
  describe('fixed columns and rows', function () {
    it('should render 4 Grids when configured for fixed columns and rows', function () {
      ...
      var topLeft = _grids[0];
      var topRight = _grids[1];
      var bottomLeft = _grids[2];
      var bottomRight = _grids[3];
    ...
    it('should render 2 Grids when configured for fixed columns only', function () {
      ...
      var bottomLeft = _grids2[0];
      var bottomRight = _grids2[1];
    ...
    it('should render 2 Grids when configured for fixed rows only', function () {
      ...
      var topRight = _grids3[0];
      var bottomRight = _grids3[1];
  ...
  describe('#recomputeGridSize', function () {
    it('should clear calculated cached styles in recomputeGridSize', function () {
      ...
      var topLeft = _grids5[0];
      var topRight = _grids5[1];
      var bottomLeft = _grids5[2];
      var bottomRight = _grids5[3];
      ...
      var topLeftAfter = _gridsAfter[0];
      var topRightAfter = _gridsAfter[1];
      var bottomLeftAfter = _gridsAfter[2];
      var bottomRightAfter = _gridsAfter[3];
