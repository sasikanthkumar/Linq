...
describe('CellSizeCache', function () {
  ...
  it('should support uniform height and width', function () {
  ...
  it('should support uniform height only', function () {
    var cellSizeCache = new CellSizeCache({
  ...
  it('should support uniform width only', function () {
    var cellSizeCache = new CellSizeCache({
      uniformColumnWidth: true,
  ...
  it('should support varying height and width', function () {
    var cellSizeCache = new CellSizeCache({
      uniformColumnWidth: false,
      uniformRowHeight: false
    });
