...
export function getCellSizeAndPositionManager(_ref) {
  ...
  var cellCount = _ref$cellCount === undefined ? CELL_SIZES.length : _ref$cellCount;
  var _ref$estimatedCellSiz = _ref.estimatedCellSize;
  var estimatedCellSize = _ref$estimatedCellSiz === undefined ? 10 : _ref$estimatedCellSiz;
...
describe('updateScrollIndexHelper', function () {
  function helper() {
    ...
    var cellCount = _ref3$cellCount === undefined ? undefined : _ref3$cellCount;
    var cellSizeAndPositionManager = _ref3.cellSizeAndPositionManager;
    var _ref3$cellSize = _ref3.cellSize;
    var cellSize = _ref3$cellSize === undefined ? 10 : _ref3$cellSize;
    var _ref3$previousCellsCo = _ref3.previousCellsCount;
    var previousCellsCount = _ref3$previousCellsCo === undefined ? undefined : _ref3$previousCellsCo;
    var _ref3$previousCellSiz = _ref3.previousCellSize;
    var previousCellSize = _ref3$previousCellSiz === undefined ? 10 : _ref3$previousCellSiz;
    var _ref3$previousScrollT = _ref3.previousScrollToAlignment;
    var previousScrollToAlignment = _ref3$previousScrollT === undefined ? 'auto' : _ref3$previousScrollT;
    var previousScrollToIndex = _ref3.previousScrollToIndex;
    var _ref3$previousSize = _ref3.previousSize;
    var previousSize = _ref3$previousSize === undefined ? 50 : _ref3$previousSize;
    var _ref3$scrollOffset = _ref3.scrollOffset;
    var scrollOffset = _ref3$scrollOffset === undefined ? 0 : _ref3$scrollOffset;
    var _ref3$scrollToAlignme = _ref3.scrollToAlignment;
    var scrollToAlignment = _ref3$scrollToAlignme === undefined ? 'auto' : _ref3$scrollToAlignme;
    var scrollToIndex = _ref3.scrollToIndex;
    var _ref3$size = _ref3.size;
    var size = _ref3$size === undefined ? 50 : _ref3$size;
