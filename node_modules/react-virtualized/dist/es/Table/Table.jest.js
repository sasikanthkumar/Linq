...
describe('Table', function () {
  ...
  function getMarkup() {
    ...
    var _ref3$columnData = _ref3.columnData;
    var columnData = _ref3$columnData === undefined ? { data: 123 } : _ref3$columnData;
    var columnStyle = _ref3.columnStyle;
    var _ref3$disableSort = _ref3.disableSort;
    var disableSort = _ref3$disableSort === undefined ? false : _ref3$disableSort;
    var headerRenderer = _ref3.headerRenderer;
    var maxWidth = _ref3.maxWidth;
    var minWidth = _ref3.minWidth;

    var flexTableProps = _objectWithoutProperties(_ref3, ['cellDataGetter', 'cellRenderer', 'columnData', 'columnStyle', 'disableSort', 'headerRenderer', 'maxWidth', 'minWidth']);
  ...
  describe('forceUpdateGrid', function () {
    it('should refresh inner Grid content when called', function () {
      ...
      function cellRenderer(_ref6) {
        ...
        var columnData = _ref6.columnData;
    ...
    it('should not set a cell :title if the rendered cell content is not a string', function () {
      var rendered = findDOMNode(render(getMarkup({
        cellRenderer: function cellRenderer(_ref10) {
          ...
          var columnData = _ref10.columnData;
          var dataKey = _ref10.dataKey;
      ...
      sortDirections.forEach(function (sortDirection) {
        ...
        var rendered = findDOMNode(render(getMarkup({
          sort: function sort(_ref11) {
            ...
            var sortDirection = _ref11.sortDirection;
        ...
        var sortBy = _sortCalls$.sortBy;
        var newSortDirection = _sortCalls$.sortDirection;
    ...
    it('should call sort with the correct arguments when a new sort-by column header is clicked', function () {
      ...
      var rendered = findDOMNode(render(getMarkup({
        sort: function sort(_ref12) {
          ...
          var sortDirection = _ref12.sortDirection;
          return sortCalls.push({ sortBy: sortBy, sortDirection: sortDirection });
        },
        sortBy: 'email',
      ...
      var sortBy = _sortCalls$2.sortBy;
      var sortDirection = _sortCalls$2.sortDirection;
    ...
    it('should call sort when a column header is activated via ENTER or SPACE key', function () {
      ...
      var rendered = findDOMNode(render(getMarkup({
        sort: function sort(_ref13) {
          ...
          var sortDirection = _ref13.sortDirection;
          return sortCalls.push({ sortBy: sortBy, sortDirection: sortDirection });
        },
        sortBy: 'name'
      })));
    ...
    it('should honor sort for custom headers', function () {
      ...
      var rendered = findDOMNode(render(getMarkup({
        ...
        sort: function sort(_ref14) {
          ...
          var sortDirection = _ref14.sortDirection;
